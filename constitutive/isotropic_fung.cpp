...
fungIso::fungIso(double mu, double b, const double Cmax[]) {
...
void fungIso::set_pars(double mu, double b, const double Cmax[]) {
    this->set_pars(mu, b);
...
void fungIso::stress(const double args[], double stress[]) {
