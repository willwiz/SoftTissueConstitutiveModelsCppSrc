...
namespace caputo_test
{
    ...
    public:
        DoubleEVE():
            HE(0.0, 0.0, 1.0, 1.0, 1.0, 0.0),
            VE(HE, 0.1, 1.0)
        {}

        DoubleEVE(double pars[], double visco[], double Tf):
            HE(pars[0], pars[1], pars[2], pars[3], pars[4], pars[5]),
            VE(HE, visco[0], Tf)
        {}
    ...
    void double_model_sim(double pars[], double visco[], double Tf, double strain[], double dt[],
