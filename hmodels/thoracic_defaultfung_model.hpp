...
#include "../constitutive/mooney.hpp"
...
namespace sim {
  ...
  public:
    ThoracicDefaultFungVEBase(double pars[], double fiber[], double visco[], double Tf):
      ThoracicDefaultFungBase(pars, fiber),
      collagen(m_collagen, visco[0], Tf)
    {}

    ThoracicDefaultFungVEBase(double pars[], double fiber[], double visco[], double Tf, double Cmax[]):
      ThoracicDefaultFungBase(pars, fiber, Cmax),
      collagen(m_collagen, visco[0], Tf)
    {}
  ...
  {
  public:
    ThoracicDefaultFungVEScaled(double pars[], double fiber[], double visco[], double Tf, double Cmax[]):
