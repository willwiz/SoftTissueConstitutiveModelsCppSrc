...
/*----------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------*/
    ...
    void ThoracicLinBase::stress(const kinematics::kinematics<4> &kin, const double dt, double stress[])
    {
        double p;
    ...
    void ThoracicLinVEBase::stress(const kinematics::kinematics<4> &kin, const double dt, double stress[])
    {
        double p;
        double el[4], smc[4], col[4];
        p = m_elastin.stress(kin, el);
