...
/*----------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------*/
    ...
    void ThoracicSMCEnsembleBase::stress(const kinematics::kinematics<4> &kin, const double dt, double stress[])
    {
        double p;
    ...
    void ThoracicSMCEnsembleVE::stress(const kinematics::kinematics<4> &kin, const double dt, double stress[])
    {
        double p;
        double mat[4], el[4], smc[4];
        p = m_matrix.stress(kin, mat);
