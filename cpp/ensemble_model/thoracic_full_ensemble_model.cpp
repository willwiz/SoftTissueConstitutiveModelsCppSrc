...
/*----------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------*/
    ...
    void ThoracicFullEnsembleBase::stress(const kinematics::kinematics<4> &kin, const double dt, double stress[])
    {
        double p = 0.0;
    ...
    void ThoracicFullEnsembleVE::stress(const kinematics::kinematics<4> &kin, const double dt, double stress[])
    {
        double p = 0.0;
        double mat[4], el[4], smc[4], col[4];
        p = m_matrix.stress(kin, mat);
