...
void simulation_function_trabeculae_passive(
    ...
    simulate_general<TrabeculaePassive>(pars, fiber, visco, Tf, Cmax, strain, dt, stress_out, n);
}
...
void simulation_function_trabeculae_calcium(
    ...
    simulate_general<TrabeculaeCalcium>(pars, fiber, visco, Tf, Cmax, strain, dt, stress_out, n);
}
