...
class TrabeculaeCalciumDiffEq : public constitutive_models::MatLawTime3D<1> {
  protected:
  ...
  public:
    TrabeculaeCalciumDiffEq(double pars[], double fiber[], double visco[], double Tf)
        : m_matrix(pars[0]), m_muscle(pars[1], pars[2], fiber[0]), f_muscle(m_muscle, visco[0], Tf),
          d_muscle(f_muscle, visco[0], visco[1], Tf), calcium(m_muscle, pars[3], visco[2]) {};
    TrabeculaeCalciumDiffEq(double pars[], double fiber[], double visco[], double Tf, double Cmax[])
        : m_matrix(pars[0]), m_muscle(pars[1], pars[2], fiber[0], Cmax[0]),
          f_muscle(m_muscle, visco[0], Tf), d_muscle(f_muscle, visco[0], visco[1], Tf),
          calcium(m_muscle, pars[3], visco[2]) {};
    ~TrabeculaeCalciumDiffEq() {};
