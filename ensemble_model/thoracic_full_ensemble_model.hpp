...
namespace ensemble {
  ...
  public:
    ThoracicFullEnsembleBase(double pars[]):
      ...
      m_collagen(pars[4], pars[5], 0.0, ctv::ideal_alpha, -ctv::ideal_alpha, ctv::M_kip, ctv::M_kop)
    {}
    ...
    ThoracicFullEnsembleBase(double pars[], double Cmax[]):
      ...
      m_collagen(pars[4], pars[5], 0.0, ctv::ideal_alpha, -ctv::ideal_alpha, ctv::M_kip, ctv::M_kop, Cmax)
    {}
  ...
  public:
    ...
    ThoracicFullEnsembleVE(double pars[], double visco[], double Tf, double Cmax[]):
      ThoracicFullEnsembleBase(pars, Cmax),
      muscle(m_muscle, visco[0], Tf),
      collagen(m_collagen, visco[1], Tf)
    {}
